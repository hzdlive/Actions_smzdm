...
const SESSION = process.env.SMZDM_SESSION
...
async function changeFiele () {
    ...
    content = content.replace(/"smzdm_cookie": ""/, `"smzdm_cookie": "${COOKIE}"`)
    content = content.replace(/"smzdm_session": ""/, `"smzdm_session": "${SESSION}"`)
